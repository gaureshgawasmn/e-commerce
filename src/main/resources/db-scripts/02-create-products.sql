...
-- Schema e-com-app
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `e-com-app`;

CREATE SCHEMA `e-com-app`;
USE `e-com-app` ;

-- -----------------------------------------------------
-- Table `e-com-app`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `e-com-app`.`product_category` (
...
-- -----------------------------------------------------
-- Table `e-com-app`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `e-com-app`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
